...
| QC-041 | warning | row | More than one audio file in the turnover folder matches the clip's name. **Reworded 2026-09-23**: it said an audio clip overlapping the video clip, from the timeline input that no longer exists; the rule is the same, more than one audio source for one plate |
